...
\newcommand{\keywords}{\autor,Entwicklung eines Instant-Messaging-Systems mit Python,Studienarbeit}

% Allgemeines für das PDF
\hypersetup{
    pdftitle={Entwicklung eines Instant-Messaging-Systems mit Python},
    pdfauthor={\autor},
    pdfcreator={\autor},
...
\begin{figure}[h]
	...
	\caption{Kommunikationsaufbau des \ac{XMPP}-Protokolls, \href{https://www.youtube.com/watch?v=ndcU3KHbFns}{Prasanth, XMPP Packet Capture and Analysis}}
...
\begin{minipage}{.5\textwidth}
  ...
  \caption{Formatierung: \texttt{YAML}, eigene Darstellung}
  \label{img:YAMLconfig}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{images/ejabberdErlangConfig}
  \caption{Formatierung: \texttt{Erlang}, eigene Darstellung}
...
\begin{figure}[h]
	...
	\caption{Status des Zookeeper-Dienstes nach dem Start, eigene Darstellung}
...
\begin{figure}[h]
	...
	\caption{Status des Kafka-Dienstes nach dem Start, eigene Darstellung}
	\label{img:StatusKafka}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Auszug aus der Konfigurationsdatei mit beispielhaften Zugangsdaten, eigene Darstellung}
...
\begin{lstlisting}[language=python, caption={Unterscheidung der Plattform für den Versand einer Nachricht an ejabberd}, label={lst:selectedPlatformCode}]
...
\begin{figure}[h]
	...
	\caption{Die Datei-Struktur nach der Bootstrap Installation,  \cite{krause2016introducing}}
...
\begin{figure}[h]
	...
	\caption{Architektur des zu entwickelnden \ac{IMS}, eigene Darstellung}
