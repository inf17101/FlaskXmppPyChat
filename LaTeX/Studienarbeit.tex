...
\begin{lstlisting}[language=python, caption={Sendevorgang der Testnachricht unter Kafka}, label={lst:testKafkaReceive}]
...
Für ein weiteres Ziel der Arbeit muss der Datenschutz im Bezug zum Projekt reflektiert werden. Hierfür ist die Relevanz des Aspektes zur Entwicklung des Prototyps zu definieren. Während im ersten Schritt der Prototyp entwickelt wird, stehen die Datenschutzaspekte im Hintergrund. Nach Abschluss des Prototyps, ist im Zuge der Weiterentwicklung die Implementierung von Datenschutzrichtlinien von Nöten. Ziel des IMS' ist es, sich gemäß der Datenschutzrichtlinien zu verhalten. Mit den definierten Minimalanforderungen an Datenschutz an ein Prototyp lässt sich das Ziel als erfüllt deklarieren. Hierbei sei anzumerken das im Zuge der Implementierung mithilfe Onlineplattformen ein Datenschutzhinweis für den Benutzer erstellt wurde.
