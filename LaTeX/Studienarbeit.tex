...
Im Schritt werden mittels \texttt{getSendingInformations()} die Informationen bereitgestellt. Dabei handelt es sich um Parameter, die für das \texttt{chat\_messages-Objekt}, der Ausgabe und dem Request an den Server, benötigt werden.
